...
<p>Simon Olsson is an Associate Professor at Chalmers University of Technology and the head of the AIMLeNS lab. He works on machine learning for molecular simulation and generative AI for molecular design, and is known for contributions to Boltzmann generators (Science 2019), implicit transfer operators (NeurIPS 2023, ICLR 2025, Sci Adv 2026), and generative molecular dynamics more broadly (Curr. Opin. Struct. Biol., 2026). He is a WASP Fellow, ELLIS Member, recipient of an ERC Consolidator Grant (2025), and the inaugural recipient of the ICTP-IBM Brahmagupta AI Prize (2025).</p>
